...
void PhoneScript_Random11(void){
    ...
    return PhoneScript_AnswerPhone_Male();
}
...
Parry:
    ...
    return PhoneScript_AnswerPhone_Male_Day();
}
...
Parry:
    ...
    return PhoneScript_AnswerPhone_Male_Nite();
}
...
Parry:
    ...
    return PhoneScript_AnswerPhone_Female();
}
...
Erin:
    ...
    return PhoneScript_AnswerPhone_Female_Day();
}
...
Erin:
    ...
    return PhoneScript_AnswerPhone_Female_Nite();
}
...
Erin:
    ...
    return PhoneScript_GreetPhone_Male();
}
...
Parry:
    ...
    return PhoneScript_GreetPhone_Male_Day();
}
...
Parry:
    ...
    return PhoneScript_GreetPhone_Male_Nite();
}
...
Parry:
    ...
    return PhoneScript_GreetPhone_Female();
}
...
Erin:
    ...
    return PhoneScript_GreetPhone_Female_Day();
}
...
Erin:
    ...
    return PhoneScript_GreetPhone_Female_Nite();
}
...
Erin:
    ...
    return PhoneScript_Generic_Male();
}
...
Parry:
    ...
    return PhoneScript_Generic_Female();
}
...
Erin:
    ...
    return PhoneScript_MonFlavorText();
}
...
unnecessary:
    ...
    return GrandmaString();
}

void GrandmaString(void){
//db "Grandma@"
    return GrandpaString();
}
